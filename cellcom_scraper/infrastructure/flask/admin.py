...
from cellcom_scraper.infrastructure.flask.model_views import (
    AccountModelView, NavigatorModelView, ScraperModelView,
    ScraperRequestExtrasModelView, ScraperRequestModelView)
...
from cellcom_scraper.infrastructure.sqlalchemy.models import (
    Account, Navigator, Scraper, ScraperRequest, ScraperRequestExtras)
