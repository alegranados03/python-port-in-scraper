...
class RequestType(str, Enum):
    ...
    GTA_FICTIVE_PORT_IN = "GTA FICTIVE PORT IN"
    GTA_FICTIVE_SIM_EXTRACTION = "GTA FICTIVE SIM EXTRACTION"
    ONT_FICTIVE_PORT_IN = "ONT FICTIVE PORT IN"
    ONT_FICTIVE_SIM_EXTRACTION = "ONT FICTIVE SIM EXTRACTION"
    ...
    WPCI_PORT_IN_NUMBER = "WPCI PORT IN NUMBER"
    WPCI_SIM_EXTRACTION = "WPCI SIM EXTRACTION"
